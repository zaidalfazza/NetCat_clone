        ...
        if self.args.execute:
            ...
            while True:
                try:
                    ...
                    print(f'server got killed ez MF {e}')
                    self.socket.close()
                    sys.exit
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Zaid Net Tool',formatter_class=argparse.RawDescriptionHelpFormatter,epilog=textwrap.dedent('''Example: 
...
'''))
    ...
    parser.add_argument('-e', '--execute', help='executespecified command')
